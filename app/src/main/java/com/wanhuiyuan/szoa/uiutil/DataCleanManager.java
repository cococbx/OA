...
public class DataCleanManager {  
     ...
     * @param context 
     */  
    public static void delDatabases(Context context) {  
    ...
    public static void clearDatabases(Context context) { 
    	FinalDb db = FinalDb.create(context, "szoa.db");
//    	db.deleteAll(OffLineUser.class);
    	db.deleteAll(MeetingYiti.class);
    	db.deleteAll(OffLineYiti.class);
    	db.deleteAll(Meeting.class);
    	db.deleteAll(YitiFile.class);
    	db.deleteAll(Postil.class);
    }
