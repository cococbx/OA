...
public class SelectUserListViewAdapter extends BaseExpandableListAdapter
	...
	private SelectUserActivity parentContext;
	...
	public SelectUserListViewAdapter(SelectUserActivity view, int myPaddingLeft) {
		parentContext = view;
...
//		}
	 ...
	 */
	private SelectUserGridViewAdapter getMenuAdapter(List<Login> childs) {
		SelectUserGridViewAdapter gvAapter = new SelectUserGridViewAdapter(
				parentContext, childs);
		return gvAapter;
	}
